...
object SchoolCalendar {
  ...
  fun getWeekNumber(date: Date = Today): Int {
   ...
   */
  fun getWeekStr(date: Date = Today): String? {
  ...
  fun getTermNumber(startYear: Int, date: Date = Today): Int {
    val startIndex = (startYear - 2010) * 2
    val nowIndex = getBeginDateIndex(date)
    return nowIndex - startIndex
  }

  fun getTermStr(startYear: Int, date: Date = Today): String? {
